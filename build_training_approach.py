...
TITLE       = "The Army Approach to Individual Training"
SUBTITLE    = "Issued by Commander, Army Training Group"
FOOTER_LEFT = "The Army Approach to Individual Training"
FOOTER_REF  = "Version 1.0"
...
HEADER_FIELDS = [
    ...
    ("Effective", "[date]"),
    ("Review", "[date]"),
    ("Applies to", "All Army individual training"),
]
...
while i < len(lines):
    ...
    if s.startswith("# ") or s.startswith("**Issued by"):

# A18009 ELDA Command Course Data Sheet
...
Retain current formal DLMS requirements, subject to confirmation against current NZDF policy:

* Medical: A4 G3 Z1 or higher.
* Fitness: Pass or higher.

### Manual Checks: Learning Provider Checks

For NZDF Civilian and non-NZDF personnel:

1. Meet applicable NZDF medical requirements for attendance on the relevant activity.
2. Attendance requires CI NZALC approval.

The current reference to HQ Joint Forces NZ SOP 10-75 is to be retained only if confirmed as current.

| Field | Entry |
| --- | --- |
| Entry Testing | N/A |
| Course Capacity | Minimum: 5<br>Maximum: 8 |
| MAP Suitability | N/A |
| MAP ADFELPS Minimum Rating | N/A |
| NZDF Civilian Suitability | Maximum number of NZDF Civilian learners: 2 |
| International (non-MAP) Suitability | Maximum number of International (non-MAP) learners: 1 |
| Non-NZDF Personnel Suitability | Maximum number of non-NZDF learners: 1 |
...
| Opening and Closing Times | Open: D-90<br>Close: D-15 |
...
Yes. The syllabus is to be aligned with the revised learning outcomes below.
